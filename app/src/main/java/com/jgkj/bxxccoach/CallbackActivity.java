...
public class CallbackActivity extends Activity implements View.OnClickListener {
    ...
    private String sendMsg = "http://www.baixinxueche.com/index.php/Home/Apitokenmsg/reMsgCoach";
    private String callbackUrl = "http://www.baixinxueche.com/index.php/Home/Apitokenmsg/forgetCoachPasswd";
    ...
    /**
     * 找回密码请求，修改密码和找回密码走的同一个接口
     * @param phone 手机号码
     * @param password 登录密码
     * @param msg 手机获取的验证码，通过上一个验证码请求返回
     */
    ...
    /**
     * 倒计时，如果60秒后手机没有获取到验证码，获取验证码过时，那么就可以重新填写
     */
