...
public class CoashAccountActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_centre_coach);
        //dialog = ProgressDialog.show(CoashAccountActivity.this,null,"加载中");
        initView();
    }
                    ...
                    public void onResponse(String s, int i) {
                        ...
                        if(groupMemberResult.getCode() == 200){
                            if(groupMemberResult.getResult() != null){
                                adapter = new GroupMemberAdapter(CoashAccountActivity.this,groupMemberResult.getResult());
        ...
        switch (view.getId()) {
            ...
            case R.id.iv_tixian:
                if ("".equals(result.getTotalMoney()) || result.getTotalMoney() == null || "0".equals(result.getTotalMoney())){
                    new RemainBaseDialog(CoashAccountActivity.this, "抱歉， " +
                    ...
                    if(datenum <= 3){
                        ...
                        new RemainBaseDialog(CoashAccountActivity.this, "抱歉，" + "提现请在每月的前三天处理").call();
                    }
                }
                break;
