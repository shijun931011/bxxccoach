...
public class ScheduleActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = ProgressDialog.show(this, null, "请求中...");
    ...
    public void onClick(View arg0) {
        switch (arg0.getId()) {
            case R.id.linearLayout1:
                ...
                adapter = new ScheduleAdapter(this, stringList,scheduleTempList);
            ...
            case R.id.btn_confirm://提交课表
                ...
                dialog = ProgressDialog.show(this, null, "请求中...");
                getSubmitTimetable(pid,day,time_solt,Urls.coachApplyCourseAgain);
        ...
        OkHttpUtils
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Exception e, int i) {
                        dialog.dismiss();
                        Toast.makeText(ScheduleActivity.this, "加载失败", Toast.LENGTH_LONG).show();
                    }
                    @Override
                    public void onResponse(String s, int i) {
                        ...
                        scheduleTempList = doscheduleList(tv1_number.getText().toString());
                        adapter = new ScheduleAdapter(ScheduleActivity.this, stringList,scheduleTempList);
                        listView.setAdapter(adapter);
                    }
                });
    }
    ...
    //教练提交课表
    private void getSubmitTimetable(final String pid,String day, String time_slot, String url) {
                ...
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String s, int i) {
                        ...
                        if (baseEntity.getCode() == 200) {
                            Toast.makeText(ScheduleActivity.this, "排课成功", Toast.LENGTH_LONG).show();
                            getUpData(pid, Urls.makeCourse);
                        }else{
                            Toast.makeText(ScheduleActivity.this, baseEntity.getReason(), Toast.LENGTH_LONG).show();
                        }
