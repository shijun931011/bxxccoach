...
public class DashboardView extends View {
    ...
    private String mHeaderText = "今日到账"; // 表头
...
//        if (value > 800) {
//            return 2 * degreePerSection + 2 * degreePerSection / 50 * (value - 800);
//        } else if (value > 600) {
//            return 2 * degreePerSection + 2 * degreePerSection / 50 * (value - 600);
//        } else if (value > 400) {
//            return 2 * degreePerSection + 2 * degreePerSection / 50 * (value - 400);
//        } else if (value > 200) {
...
//        }
    ...
    private String getFormatTimeStr() {
        ...
        return String.format("到账时间:%s", mDateFormat.format(new Date()));
    }
